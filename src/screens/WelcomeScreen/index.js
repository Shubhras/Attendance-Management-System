...
const OnboardingData = [
  {
    ...
    description:
      'Managing your work schedule and attendance has never been easier.',
  },
  {
    id: '2',
    ...
    description:
      'View upcoming shifts, request time off, and manage your work calendar with ease.',
  },
  {
    id: '3',
    ...
    description:
      'Use biometric authentication to clock in and out securely from your mobile device.',
  },
];
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <TouchableOpacity
          onPress={() => {
            handleWelcome(), navigation.navigate('LogInScreen');
          }}
        >
          <CustomText
            style={[
