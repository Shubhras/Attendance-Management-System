...
//         Route::get('/addContractor', 'addContractor')->name('addContractor');
//         // Route::get('/roleAaccess', 'roleAaccess')->name('roleAaccess');
//     });
// });
...
//     // Resource routes using route-model-binding by uuid (model getRouteKeyName handles it)
//     Route::resource('contractors', ContractorController::class)->except(['destroy']);
//     // destroy with explicit route (to confirm modal posts to this)
...
Route::post('/attendance/save-bulk', [AttendanceController::class, 'saveBulk'])->name('attendance.saveBulk');
Route::get('/attendance-summary', [AttendanceController::class, 'summary'])
     ->name('attendance.summary');
    Route::get('/salary', [SalaryController::class, 'index'])->name('salary.index');
    Route::post('/salary/calculate', [SalaryController::class, 'calculate'])->name('salary.calculate'); // Ajax
...
// Route::post('/employees/{uuid}/restore', [EmployeeController::class, 'restore'])->name('employees.restore');
// Route::resource('operators', OperatorController::class);    
