    ...
    <section class="auth bg-base d-flex flex-wrap">
        <div class="auth-left d-lg-block d-none">
            <div class="d-flex align-items-center flex-column h-100 justify-content-center">
                <img src="{{ asset('assets/images/auth/attendence (1).jpg') }}" alt="" style="width: 917px;height:850px">
            </div>
        </div>
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                {{-- ✅ Show Error Messages --}}
                @if ($errors->any())
                <div class="alert alert-danger radius-12 py-3 px-4 mb-3">
                    <ul class="mb-0 ps-3">
                ...
                @if (session('success'))
                <div class="alert alert-success radius-12 py-3 px-4 mb-3">
                    {{ session('success') }}
                </div>
                @endif
                <div>
