<aside class="sidebar">
        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a  href='/contractors'><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Contractor</a>
                    </li>
                     <li>
                        <a  href='/machines'><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Machine</a>
                    </li>
                    <li>
                        <a  href='/employees-get'><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Employees</a>
                    </li>
                    <li>
                        <a  href='/shifts'><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Add Shift</a>
                    </li>
                    <li>
                        <a href="/attendance">
    ...
    <a href="/salary">
        ...
        Pay Salary
                    ...
                    <li>
                        <a  href='/operators'><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Assign Operators</a>
                    </li>
                </ul>
            </li>
