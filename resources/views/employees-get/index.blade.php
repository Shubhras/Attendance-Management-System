    ...
    @endphp
<style>
.empCheckbox, #selectAll {
    width: 18px !important;
    height: 18px !important;
    cursor: pointer;
    accent-color: #0d6efd; /* makes checkbox visible */
}

/* Force visibility if theme hides it */
input[type="checkbox"] {
    opacity: 1 !important;
    ...
    <div class="card h-100 p-0 radius-12">
                ...
                <form method="GET" action="{{ route('employees-get.index') }}" class="d-flex align-items-center gap-2">
                    ...
                    <div class="navbar-search">
                        ...
                        <button class="btn btn-primary" type="submit" style="border:none;">
                            ...
                            <a href="{{ route('employees-get.index') }}" class="btn btn-secondary">
                                Reset
                            </a>
                    </div>
                </form>
        ...
        <!-- Table Section -->
         <div class="mb-3" style="margin: 10px 20px;">
    ...
    <input type="checkbox" class="empCheckbox form-check-input" value="{{ $employee->id }}">
</td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <form method="POST" action="{{ route('employees-get.toggle-status', $employee->uuid) }}" style="display:inline;">
                                        @csrf
                                        <button type="submit" class="btn btn-sm {{ $employee->is_active ? 'btn-secondary' : 'btn-info' }}" title="{{ $employee->is_active ? 'Deactivate' : 'Activate' }}">
                                            <iconify-icon icon="{{ $employee->is_active ? 'mdi:account-off-outline' : 'mdi:account-check-outline' }}"></iconify-icon>
                                        </button>
                                    </form>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function printSelected() {
        ...
        document.querySelectorAll('.empCheckbox:checked').forEach(el => {
            ids.push(el.value);
        });
        ...
        let url = "/employees/print-multiple?ids=" + ids.join(',');
